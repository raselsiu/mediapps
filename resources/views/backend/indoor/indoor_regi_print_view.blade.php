    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Indoor</li>
            </ol>
        </div>
    </div>
    <br>
        ...
        <div class="indoor_outer_card">
            <div class="card">
                <div class="card-header">
                    <h1 class="card-title">Indoor Patients</h1>
                    &nbsp;&nbsp;
                    <a href="{{ route('all_regi_patient') }}" class="btn btn-info">View Patients </a>
                        ...
                        <div class="card-body box-profile">
                            ...
                            <table id="tobeprint" class="list-group list-group-unbordered mb-3" style="font-size: 20px;">
                                ...
                                <li class="list-group-item" style="font-size: 18px;">
                                    ...
                                    <p class="float-right">Phone: {{ $patient->mobile }}</p>
                                </li>
                                <li class="list-group-item" style="font-size: 18px;">
                                    Patient Name:-
                                ...
                                <li class="list-group-item" style="font-size: 18px;">
                                    ...
                                    <p class="float-right" style="font-size: 18px;">
                                        {{ $patient->present_address }} {{ $patient->pre_post_code }}
                                        {{ $patient->pre_thana }} {{ $patient->pre_district }}
                                    </p>
                                </li>
                                <li class="list-group-item" style="font-size: 18px;">
                                    Registration Fee:-
